...
typedef void xli_handler(struct xcl_context *xcp, struct xli *xlip, struct ilem_form *fp, Form *f2p);
...
extern void xli_ilem(struct xcl_context *xcp, struct ilem_form *f, Form *fp);

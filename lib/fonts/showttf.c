/* showttf.c was obtained from
   https://github.com/fontforge/fontforge/blob/master/contrib/fonttools/showttf.c
   on 2024-10-21; although the file does not have an explicit license,
   fontforge generally is under the BSD 3-Clause License,
   https://opensource.org/license/bsd-3-clause which is assumed here
   to apply to this file as well.

   For Oracc the executable is named showttfx to preempt the
   possibility that Oracc-related changes will create an incompatible
   version of showttf.
 */

...
void
hash_add (Hash *htab, const unsigned char *key, void *data)
{
...
void
hash_freeable_data(Hash *h,int i)
{
  h->freeable_data = i;
}
...
void
hash_free (Hash *htab, void (*fnc)(void *))
{
  hash_free2(htab,NULL,fnc);
}

void
hash_free2 (Hash *htab, void (*keyfnc)(void *), void (*datfnc)(void *))
{
  Unsigned32 i, j;
  Hash_element *p, *q;
...
Hash_address_t
_hash_hash (Hash *htab, const unsigned char *key)
{
...
Hash_element *
_hash_lookup (Hash *htab, const unsigned char *key, Hash_element ***p_p)
{
  Hash_address_t h;
...
void
hash_exec (Hash *htab, void (*fnc)(void *))
{
  Unsigned32 i, j;
  Hash_element **s, *p;
...
void
hash_exec_user (Hash *htab, void (*fnc)(void *, void*), void *user)
{
  Unsigned32 i, j;
  Hash_element **s, *p;
...
void
hash_exec2 (Hash *htab, void (*fnc)(const unsigned char *,void *))
{
  Unsigned32 i, j;
  Hash_element **s, *p;
...
void
hash_exec_user_key (Hash *htab, void (*fnc)(const unsigned char *, void*), void *user)
{
  Unsigned32 i, j;
  Hash_element **s, *p;
...
void
hash_exec_user_key_data (Hash *htab, void (*fnc)(const unsigned char *, void*, void *), void *user)
{
  Unsigned32 i, j;
  Hash_element **s, *p;
...
const char **
hash_keys2 (Hash *htab, int *nkeys)
{
  Unsigned32 i, j;
  Hash_element **s, *p;

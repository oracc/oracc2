...
#define FORM_FLAGS_NGRAM_MATCH 0x00001000
#define FORM_FLAGS_NGRAM_KEEP  0x00002000
#define FORM_FLAGS_LEM_BY_NORM 0x00004000
#define FORM_FLAGS_NORM_IS_CF  0x00008000
#define FORM_FLAGS_NEW_BY_PROJ 0x00010000
#define FORM_FLAGS_NOT_IN_SIGS 0x00020000
#define FORM_FLAGS_EXTENDED_OK 0x00040000
#define FORM_FLAGS_NEW_BY_LANG 0x00080000
#define FORM_FLAGS_COF_INVALID 0x00100000
#define FORM_FLAGS_FROM_CACHE  0x00200000
#define FORM_FLAGS_DEF_FORM    0x00400000
#define FORM_FLAGS_DEF_ESENSE  0x00800000
#define FORM_FLAGS_DEF_ISENSE  0x01000000
#define FORM_FLAGS_READ_ONLY   0x02000000
#define FORM_FLAGS_CLEARED     0x04000000
#define FORM_FLAGS_NEWLITERAL  0x08000000
#define FORM_FLAGS_IMPLICIT    0x10000000
#define FORM_FLAGS_PSU_PART    0x20000000
#define FORM_FLAGS_PSU_FORM    0x40000000
#define FORM_FLAGS_PSU_INST    0x80000000

#define FORM_FLAGS_PSU_BITS (FORM_FLAGS_PSU_PART|FORM_FLAGS_PSU_FORM|FORM_FLAGS_PSU_INST)
...
extern void form_psu_init(void);
extern void form_psu_term(void);

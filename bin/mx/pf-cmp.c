...
static void
cmp_before_block(void)
{
}

static void
cmp_after_block(void)
{
}

static void
cmp_before_sources(void)
{
}

static void
cmp_between_sources(void)
{
}

static void
cmp_after_sources(void)
{
}

static void
cmp_before_composite(void)
{
}

static void
cmp_after_composite(void)
{
}

static void
cmp_each_composite_column(void)
{
  if (iterate_block->composite == iterate_block->reconstructed)
      ...
      else
	{
	  ...
	  while (iccp->right && !strcmp((ccp)iccp->right->text, "0"))
	    {
	      iccp = iccp->right;
	      iccp->done = TRUE;
...
static void
cmp_between_composite_columns(void)
{
}

static void
cmp_before_reconstructed(void)
{
}

static void
cmp_after_reconstructed(void)
{
}

static void
cmp_each_reconstructed_column(void)
{
  Uchar * best_delim;
...
static void
cmp_between_reconstructed_columns(void)
{
}

static void
cmp_before_source(void)
{
}

static void
cmp_after_source(void)
{
}

static void
cmp_each_source_column(void)
{
}

static void
cmp_between_source_columns(void)
{
}

static void
cmp_before_notes(void)
{
}

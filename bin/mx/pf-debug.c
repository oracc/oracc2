...
static void
debug_before_outers(void)
{
  indent += 2;
}

static void
debug_each_outer (void)
{
  indent -= 2;
  do_indent ();
...
static void
debug_each_text(void)
{
}

static void
debug_before_block(void)
{
  do_indent ();
...
static void
debug_each_composite_column(void)
{
  List *vlist;
...
static void
debug_between_composite_columns(void)
{
}

static void
debug_before_reconstructed(void)
{
  do_indent ();
...
static void
debug_after_reconstructed(void)
{
  indent -= 2;
  do_indent ();
...
static void
debug_each_reconstructed_column(void)
{
  do_indent ();
...
static void
debug_between_reconstructed_columns(void)
{
}
static void
debug_before_source(void)
{
  do_indent ();
...
debug_each_source_column(void)
{
  ...
  fprintf (ipf->output_fp, "\tcomposite = %p; composite_end = %p\n", 
	   (void*)iterate_source_column->composite,
	   (void*)iterate_source_column->composite_end);
  do_indent ();
  fprintf (ipf->output_fp, "  complex = %p ", (void*)iterate_source_column->complex);
...
static void
debug_between_source_columns(void)
{
}

static void
debug_before_notes(void)
{
}

static void
debug_each_note(void)
{
}

static void
debug_after_notes(void)
{
}

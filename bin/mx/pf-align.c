...
static void
align_before_outers(void)
{
}

static void
align_each_outer(void)
{
#if 0
...
static void
align_each_text(void)
{
  fprintf (ipf->output_fp, "%s", iterate_text);
}

static void
align_before_block(void)
{
}

static void
align_after_block(void)
{
  fprintf (ipf->output_fp, "\n");
}

static void
align_before_sources(void)
{
}

static void
align_between_sources(void)
{
}

static void
align_after_sources(void)
{
}

static void
align_before_composite(void)
{
}

static void
align_after_composite(void)
{
  fprintf (ipf->output_fp, "\n");
}

static void
align_each_composite_column(void)
{
...
static void
align_between_composite_columns(void)
{
}

static void
align_before_reconstructed(void)
{
}

static void
align_after_reconstructed(void)
{
  fprintf (ipf->output_fp, "\n");
}

static void
align_each_reconstructed_column(void)
{
#if 0
...
static void
align_between_reconstructed_columns(void)
{
}

static void
align_before_source(void)
{
}

static void
align_after_source(void)
{
  fprintf (ipf->output_fp, "\n");
}
...
static void
align_between_source_columns(void)
{
}

static void
align_before_notes(void)
{
  n_notes = 0;
  fputc ('\n', ipf->output_fp);
}
...
static void
align_each_note(void)
{
  if (n_notes && !strncmp((ccp)iterate_text,"#note:",6))
    fputc ('\n', ipf->output_fp);
  fprintf (ipf->output_fp, "%s", iterate_text);
  ++n_notes;
}

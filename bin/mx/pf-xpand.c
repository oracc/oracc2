...
static void
expand_before_outers(void)
{
}

static void
expand_each_outer (void)
{
}

static void
expand_between_outers(void)
{
}

static void
expand_after_outers(void)
{
}

static void
expand_each_text(void)
{
}

static void
expand_before_block(void)
{
}

static void
expand_after_block(void)
{
}

static void
expand_before_sources(void)
{
}

static void
expand_between_sources(void)
{
}

static void
expand_after_sources(void)
{
}

static void
expand_before_composite(void)
{
  list_exec (iterate_line->columns, phantom_prepare_phantoms);
}

static void
expand_after_composite(void)
{
}

static void
expand_each_composite_column(void)
{
  ...
  if (iterate_composite_column->complex == iterate_composite_column)
      ...
      if (tmp)
	{
	  ...
	  iterate_composite_column->complex_text = (ucp)xstrdup ((ccp)tmp);
	}
    }
}

static void
expand_between_composite_columns(void)
{
}

static void
expand_before_reconstructed(void)
{
}

static void
expand_after_reconstructed(void)
{
}

static void
expand_each_reconstructed_column(void)
{
}

static void
expand_between_reconstructed_columns(void)
{
}

static void
expand_before_source(void)
{
}

static void
expand_after_source(void)
{
}

static void
expand_each_source_column(void)
{
  if (iterate_source_column->complex == iterate_source_column
	...
	{
	  /*fprintf(stderr,"Expand returned: %s\n",tmp);*/
	  iterate_source_column->complex_text = (ucp)xstrdup ((ccp)tmp);
	}
    }
}

static void
expand_between_source_columns(void)
{
}

static void
expand_before_notes(void)
{
}

static void
expand_each_note(void)
{
}

static void
expand_after_notes(void)
{
}

...
static int mtx_output_col_count;
#if 0
static int mtx_template_phantoms, 
...
static void
mtx_between_outers(void)
{
}

static void
mtx_after_outers(void)
{
  P0("</matrix>");
}
...
static void
mtx_before_block(void)
{
  P0("<b>");
}

static void
mtx_after_block(void)
{
  P0("</b>\n");
}

static void
mtx_before_sources(void)
{
}

static void
mtx_between_sources(void)
{
}

static void
mtx_after_sources(void)
{
}

static void
mtx_before_composite(void)
{
  curr_complex = 0;
  P0("<l>");
}
...
static void
mtx_each_composite_column(void)
{
...
static void
mtx_between_composite_columns(void)
{
}

static void
mtx_before_reconstructed(void)
{
  P0("<r>");
}

static void
mtx_after_reconstructed(void)
{
  P0("</r>");
}

static void
mtx_each_reconstructed_column(void)
{
  P0("<c");
...
static void
mtx_between_reconstructed_columns(void)
{
}

static void
mtx_before_source(void)
{
  curr_s_complex = -1;
  P0("<s>");
}
...
static void
mtx_between_source_columns(void)
{
}

static void
mtx_before_notes(void)
{
}

...
/* Command-line: /Library/Developer/CommandLineTools/usr/bin/gperf -N ax_check -tT ax_check.g  */
...
ax_check (str, len)
     ...
     register size_t len;
{
  static struct catinfo wordlist[] =
    {
      {""}, {""}, {""},
#line 9 "ax_check.g"
...
#line 14 "ax_check.g"
      {"equiv",    		CI_CHILD  , 4 , 0, ax_gparse, NULL, NULL},
#line 13 "ax_check.g"
